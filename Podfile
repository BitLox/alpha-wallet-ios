...
target 'AlphaWallet' do
  ...
  pod 'QRCodeReaderViewController', :git=>'https://github.com/vladyslav-iosdev/QRCodeReaderViewController.git',:branch=>'#1814', :commit=>'1e1957c02b0473167773bc1c00c36d3821b12311'
